...
#import "SCMenuDefinition.h"

@interface SCDropDownMenuView : UIView
...
/**代理*/
@property (nonatomic, weak) id<SCDropDownMenuViewDelegate> delegate;
...
/**各个菜单风格数组, 默认都为SCDropDownMenuStyleTableView*/
...
/**Item选中字体颜色, 默认橙红色*/ // kColorWithRGB(211,0,0)
